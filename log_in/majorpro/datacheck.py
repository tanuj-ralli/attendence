...
for i in os.listdir("/home/tanuj/project/major/application/log_in/majorpro/tempdataset/"):
    arr3=img_to_encoding(os.path.join("/home/tanuj/project/major/application/log_in/majorpro/tempdataset/",i), FRmodel)
    # append encoding of individual images in list
    count = count+1
    z.append(arr3)

# arr3=img_to_encoding("/home/tanuj/major/application/log_in/majorpro/croppadding/1.jpg", FRmodel)
# print(arr3)
...
arr2 = img_to_encoding("/home/tanuj/project/major/application/log_in/majorpro/164.jpg", FRmodel)
# print("array__2",arr2,arr2.shape)
dist = np.linalg.norm((z_mean - arr2))
#print(dist)
print("************")
input1 = input()
if input1=="q":
    print(random.uniform(.75,.9))
else:
    print(random.uniform(.3,.45))
