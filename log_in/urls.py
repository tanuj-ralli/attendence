...
urlpatterns = [
    ...
    path('teacher/add', views.TeacherCreate, name='add_teacher'),
    path('teacher/update/<int:id>', views.TeacherUpdate, name='update_teacher'),
    path('teacher/delete', views.deleteteacher, name='delete_teacher'),
    path('teacherlist/', views.teachers_list, name='teachers_list'),
    path('teacherlist/data', views.teachers_list_data, name='teachers_list_data'),
    ...
    path('user/model/upload', views.PhotoUpload, name='photoupload'),
    ...
    path('teacher/home', views.TeacherDash, name='teacherdash'),
    path('teacher/attendance', views.Attendance, name='attendance'),
    path('attendance/list/', views.attendance_list, name='attendance_list'),
    path('attendance/data', views.attendance_list_data, name='attendance_list_data'),
    path('attendance/update/<int:id>', views.UpdateAttendance, name='update_attendance'),
    path('attendance/delete', views.deleteattendance, name='delete_attendance'),
