...
class UserDataForm(ModelForm):
    class Meta:
        model=UserData
        fields = ['rollno','username','email','branch','yod']

class TeacherDataForm(ModelForm):
    class Meta:
        model=TeacherData
        fields = ['tname','tid','temail','tpassword']

class TeacherLoginForm(ModelForm):
    class Meta:
        model=TeacherData
        fields = ['tid','tpassword']

class AttendanceDBForm(ModelForm):
    class Meta:
        model=AttendanceDB
        fields = ['date','subject','yod','branch']

class UpdateAttendanceForm(ModelForm):
    class Meta:
        model=AttendanceDB
        fields = ['date','subject','yod','branch','s1','s2','s3','s4','s5','s6','s7','s8','s9','s10']
